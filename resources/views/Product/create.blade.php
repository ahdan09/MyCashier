                ...
                <form method="POST" action="{{ route('product.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" class="form-control" id="harga_beli" name="harga_beli"
                            aria-describedby="emailHelp" :value="old('harga_beli')" required>
                    </div>
                    <div class="mb-4">
                        <label for="harga_jual" class="form-label shadow-md text-muted">Harga Jual</label>
                        <input type="number" class="form-control" id="harga_jual" name="harga_jual"
                            aria-describedby="emailHelp" :value="old('harga_jual')" required>
                    </div>
                    <div class="mb-4">
                        <label for="stock" class="form-label shadow-md text-muted">stok</label>
                        <input type="number" class="form-control" id="stock" name="stock"
                            aria-describedby="emailHelp" :value="old('stock')" required>
                    </div>
